...
return [
    ...
    */
    ...
    'username_attribute' => ['nr_cpf' => env('LDAP_USERNAME_ATTRIBUTE')],
    ...
    */
    ...
    'login_attribute' => env('ADLDAP_LOGIN_ATTRIBUTE', env('LDAP_LOGIN_ATTRIBUTE')),
    ...
    */
    ...
    'sync_attributes' => [
        ...
        'no_usuario' => 'uid', // Trocar em Produção/Homologação "uid" mudado de "cn" voltar depois

        //'email' => 'mail' // Habilitar em Produção/Homologação
