...
<div class="row">
    <div class="col-sm-4">
        <div class="form-group">    
            ...
            {!! Form::select('in_area_atendimento',$areaAtendimento, null, ['class'=>'form-control']) !!}
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
            {!! Form::label('tipoAfastamento', 'Tipo de Afastamento:') !!}
            {!! Form::select('in_tipo_afastamento',$tipoAfastamento, null, ['class'=>'form-control']) !!}
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
...
<div class="row">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            {!! Form::select('in_situacao',$situacao, null, ['class'=>'form-control', 'id' => 'in_situacao']) !!}
