		...
		<div class="widget-box widget-color-grey" id="widget-box-2">
			<div class="widget-header">
				...
				<div class="widget-toolbar no-border">
					<a href="#" class="btn btn-sm btn-success insert_usuario" data-url="{{route('gescon::contratante_usuario.create', ['id_contratante' => $contratante->id_contratante])}}" data-rel="tooltip" data-original-title="Adicionar Usuário">
			...
			<div class="widget-body">
				<div class="widget-main no-padding">
					<div class="table-container-usuario">
						@include('gescon::contratantes.usuario._tabela_usuarios')
					</div>
				</div>
			</div>
		</div>	
...
@section('script-end')
    ...
    <script type="text/javascript">
        jQuery(function($) {                
        	...
        	$.fn.dinamic_table_usuario = function() {
        	    //inicializa dataTables
        	    var oTable1 = $('#dynamic-table-usuario')
        	        .dataTable({
        	            bAutoWidth: false,
        	            info:     false,
        	            searching: false,
