...
@section('breadcrumbs-page')
    ...
    {!! Breadcrumbs::render('sisadm::operacao_favorita.index') !!}
...
@section('content')
    ...
    {!! Form::open(['route'=>['sisadm::operacao_favorita.store']]) !!}
    ...
    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
        ...
        <tbody>
            @php ($sistemaOperacao = '')
                ...
                @if($operacao->no_sistema != $sistemaOperacao || $sistemaOperacao == '')
                    ...
                    <tr>
                        <td class="center">
                            <label class="pos-rel">
                                {!! Form::checkbox("ids_operacoes[]", $operacao->id_operacao, in_array($operacao->id_operacao,$operacoes_favoritas),['class'=>'ace']) !!}
                                <span class="lbl"></span>
                            </label>
                        </td>
                        <td>{!! $operacao->ds_operacao !!}</td>
                        <td>{!! $operacao->no_sistema !!} </td>
                    </tr>
                @else
                    <tr>
                        <td class="center">
                ...
                @php ($sistemaOperacao = $operacao->no_sistema)
                @endforeach
        </tbody>
    </table>
