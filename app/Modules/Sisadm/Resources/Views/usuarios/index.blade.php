...
@section('content')
    ...
    <a href="#" class="btn btn-sm btn-primary insert" data-url="{{route('sisadm::usuarios.create')}}">
    ...
    <div class="table-container">
        @include('sisadm::usuarios._tabela')
    </div> 

    <div class="formulario-container">
        @include('sisadm::usuarios._modal')
    </div>     
        ...
        $(function() {
            $.fn.dinamic_table = function() {
                var oTable = $('#dynamic-table').DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: '{!! route('sisadm::usuarios.records') !!}',
