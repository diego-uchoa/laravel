...
<body>
  ...
  <div class="container">
    ...
    <div class="titulo"> 
        Podium - 
        <label style="font-weight: normal;"> {{trans('prisma-bi::pdf.melhores-curto-prazo')}} </label> 
    </div>
   ...
   @foreach(json_decode($dados, true) as $value)
      ...
      <table class="tabela">
        ...
        <tr> 
          ...
          <td class="tb-podium-posicao" style="text-align:center">{{trans('prisma-bi::pdf.nota')}}</td>
        </tr>
    ...
    @endforeach
    <div class="rodape"> 
       {{ trans('prisma-bi::pdf.observacao3')}}
    </div>
