...
@section('breadcrumbs-page')
    ...
    {!! Breadcrumbs::render('parla::tiposPosicao.index') !!}
...
@section('content')
    ...
    <a href="#" class="btn btn-sm btn-primary insert" data-url="{{route('parla::tiposPosicao.create')}}">
    ...
    <div class="table-container">
        @include('parla::tipos_posicao._tabela')
    </div> 

    <div class="formulario-container">
        @include('parla::tipos_posicao._modal')
    </div> 
