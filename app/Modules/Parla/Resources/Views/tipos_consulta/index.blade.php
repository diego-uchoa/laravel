...
@section('breadcrumbs-page')
    ...
    {!! Breadcrumbs::render('parla::tiposConsulta.index') !!}
...
@section('content')
    ...
    <a href="#" class="btn btn-sm btn-primary insert" data-url="{{route('parla::tiposConsulta.create')}}">
    ...
    <div class="table-container">
        @include('parla::tipos_consulta._tabela')
    </div> 

    <div class="formulario-container">
        @include('parla::tipos_consulta._modal')
    </div> 
