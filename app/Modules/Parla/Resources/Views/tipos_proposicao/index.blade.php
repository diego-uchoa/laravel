...
@section('breadcrumbs-page')
    ...
    {!! Breadcrumbs::render('parla::tiposProposicao.index') !!}
...
@section('content')
    ...
    <a href="#" class="btn btn-sm btn-primary insert" data-url="{{route('parla::tiposProposicao.create')}}">
    ...
    <div class="table-container">
        @include('parla::tipos_proposicao._tabela')
    </div> 

    <div class="formulario-container">
        @include('parla::tipos_proposicao._modal')
    </div> 
