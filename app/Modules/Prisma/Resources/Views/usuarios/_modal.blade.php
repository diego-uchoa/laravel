<div class="modal fade" id="modal-create" role="dialog" data-toggle="modal">
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			@if($mode == "update")
				{!! Form::model($usuario, ['route'=>['prisma::usuarios.update', $usuario->id_usuario], 'method'=>'put', 'id'=>'formulario']) !!}
			...
			@else
				{!! Form::open(['route'=>'prisma::usuarios.store', 'id'=>'formulario']) !!}
				<div class="modal-header">
					<a class="close" data-dismiss="modal">&times;</a>
			...
			@endif
				...
				<div class="modal-body">
					@include('prisma::usuarios._form',['submit_text' => 'Salvar'])
				</div>
