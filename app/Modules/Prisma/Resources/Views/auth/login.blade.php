...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>PRISMA FISCAL - Login</title>
		...
		{{ Html::style('modules/prisma/css/navbar.css') }}
			...
			<div class="navbar-container" id="navbar-container">
				<div class="navbar-header pull-left">
					<a href="{{ url('/') }}" class="navbar-brand">
						<small>
							{{ Html::image('icones/thumbnail_PRISMA.png', 'PRISMA',array('height' => 25, 'style' => 'padding-right:10px' )) }}
								...
								<div class="position-relative">
									<div id="login-box" class="login-box visible widget-box no-border">
										<div class="widget-body">
											...
											<div class="toolbar clearfix" style="background: #0E3455;">
												<div>
					...
					<div class="footer">
						<div class="footer-inner">
							<div class="footer-content">
								<span class="blue bolder">Central de Atendimento Prisma - </span>prisma@fazenda.gov.br | (61) 2021-5379
							</div>
						</div>
					</div>
				</div><!-- /.row -->	
